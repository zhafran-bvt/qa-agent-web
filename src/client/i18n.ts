...
export const uiText = {
  en: {
    ...
    analyze: {
      title: 'Analyze Jira',
      subtitle: 'Start with the main ticket, scope toggles, and QA notes.',
      jiraTicketKey: 'Jira Ticket Key',
      feOnlyScope: 'FE-only scope',
      beAlreadyTested: 'BE already tested',
      includeComments: 'Include comments',
      scopeNotes: 'Scope Notes',
      scopeNotesPlaceholder: 'Optional constraints, exclusions, or QA notes',
      analyzing: 'Analyzing...',
  ...
  id: {
    ...
    analyze: {
      title: 'Analisis Jira',
      subtitle: 'Mulai dari tiket utama, toggle scope, dan catatan QA.',
      jiraTicketKey: 'Key Tiket Jira',
      feOnlyScope: 'Scope FE aja',
      beAlreadyTested: 'BE sudah dites',
      includeComments: 'Ikut ambil komentar',
      scopeNotes: 'Catatan Scope',
      scopeNotesPlaceholder: 'Catatan QA, batasan, atau pengecualian opsional',
